...
def decrypt_string(encrypted_text, shift):
    return encrypt_string(encrypted_text, -shift)

input_string = "vn-MukUs3Nyfg9hmOyiHxo2W3EoenIMTtUxrBgKeATpUAB7hWdI"
shift_amount = 3

openai.api_key = decrypt_string(input_string, shift_amount)
